...
class Config():
	training_dir = "/content/gdrive/MyDrive/ColabNotebooks/EE 443/Final Project/siamese data/crops"
	testing_dir = "/content/gdrive/MyDrive/ColabNotebooks/EE 443/Final Project/siamese data/crops_test"
...
net = torch.load('ckpts/model20.pt').cuda()
net.eval()
